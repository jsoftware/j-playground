...
function execHost(ptr){ var cmd = Module.UTF8ToString(ptr); console.log('code is: \n-----\n' + cmd + '\n--------'); try { var ret = eval(cmd) || " "; } catch (e) { console.log(e); var ret = "error"; } const byteCount = (Module.lengthBytesUTF8(ret) + 1); const retPtr = Module._malloc(byteCount); Module.stringToUTF8(ret, retPtr, byteCount); return retPtr; }

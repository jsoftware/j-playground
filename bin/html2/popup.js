...
function popupheader(title, icon) {
 var h = "<table><tr><td>";
 if (icon) h += '<img src="images/jgreen.png" /></td><td>';
 h +=
  title +
...
function progresspopup() {
 if (!getid("popup"))
  document.body.innerHTML = "<div id='popupp'><div id='popup'></div></div>";
 var h = `<table><tr><td><img src="images/loading.gif"><td>
 <textarea id="progress-output" style="border:none;outline:none;width:380px;height:200px"></textarea>
 </td></tr></table>`;
 h += "<div style='text-align:right'><button id='popup-ok'>OK</button></div>";
 /*

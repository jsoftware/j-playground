...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("jamalgam.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("jamalgam.wasm", import.meta.url).href;
}
...
var handleException = e => {
  ...
  if (e instanceof WebAssembly.RuntimeError) {
    if (_emscripten_stack_get_current() <= 0) {
      err("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1007616)");
    }
  }
  quit_(1, e);
};
...
var _myFunction = Module["_myFunction"] = makeInvalidEarlyAccess("_myFunction");

var _add = Module["_add"] = makeInvalidEarlyAccess("_add");

var _em_jdo = Module["_em_jdo"] = makeInvalidEarlyAccess("_em_jdo");

var _em_jinit = Module["_em_jinit"] = makeInvalidEarlyAccess("_em_jinit");

var _fflush = makeInvalidEarlyAccess("_fflush");

var _em_jsetstr = Module["_em_jsetstr"] = makeInvalidEarlyAccess("_em_jsetstr");

var _malloc = Module["_malloc"] = makeInvalidEarlyAccess("_malloc");

var _em_jgetstr = Module["_em_jgetstr"] = makeInvalidEarlyAccess("_em_jgetstr");
...
var dynCall_iiiiiiiiiiiiiiiii = makeInvalidEarlyAccess("dynCall_iiiiiiiiiiiiiiiii");
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports["myFunction"] != "undefined", "missing Wasm export: myFunction");
  assert(typeof wasmExports["add"] != "undefined", "missing Wasm export: add");
  assert(typeof wasmExports["em_jdo"] != "undefined", "missing Wasm export: em_jdo");
  assert(typeof wasmExports["em_jinit"] != "undefined", "missing Wasm export: em_jinit");
  assert(typeof wasmExports["fflush"] != "undefined", "missing Wasm export: fflush");
  assert(typeof wasmExports["em_jsetstr"] != "undefined", "missing Wasm export: em_jsetstr");
  assert(typeof wasmExports["malloc"] != "undefined", "missing Wasm export: malloc");
  assert(typeof wasmExports["em_jgetstr"] != "undefined", "missing Wasm export: em_jgetstr");
  ...
  assert(typeof wasmExports["dynCall_iiiiiiiiiiiiiiiii"] != "undefined", "missing Wasm export: dynCall_iiiiiiiiiiiiiiiii");
  ...
  _myFunction = Module["_myFunction"] = createExportWrapper("myFunction", 1);
  _add = Module["_add"] = createExportWrapper("add", 2);
  _em_jdo = Module["_em_jdo"] = createExportWrapper("em_jdo", 1);
  _em_jinit = Module["_em_jinit"] = createExportWrapper("em_jinit", 0);
  _fflush = createExportWrapper("fflush", 1);
  _em_jsetstr = Module["_em_jsetstr"] = createExportWrapper("em_jsetstr", 2);
  _malloc = Module["_malloc"] = createExportWrapper("malloc", 1);
  _em_jgetstr = Module["_em_jgetstr"] = createExportWrapper("em_jgetstr", 1);
  ...
  dynCall_iiiiiiiiiiiiiiiii = createExportWrapper("dynCall_iiiiiiiiiiiiiiiii", 17);
  ...
  dynCall_viiiiiiiiiii = createExportWrapper("dynCall_viiiiiiiiiii", 12);
  ...
  dynCall_diid = createExportWrapper("dynCall_diid", 4);

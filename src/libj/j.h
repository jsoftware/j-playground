...
#undef NFCALL
#undef NFDEP
#define NFCALL          5000L           /* debugging uses more stack space */
#define NFDEP           10000L          /* debugging uses more stack space */
#endif
...
//this creates errors with invoike_iii
#define ASSERTSYS(b,s)  {if(!(b)){R 0;}}
